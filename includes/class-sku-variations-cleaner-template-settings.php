...
class SKU_Variations_Cleaner_Template_Settings {
	...
	public function settings_page () {
		...
		$html .= '<tr><th scope="row">' . __( 'Search old product variations' ) . '<p class="description">' . __( 'Click Start search button to start the search of old variations.' ) . '</p></th><td><button class="button button-primary">' . __( 'Start search old variations' ) . '</button></td></tr>' . "\n";

		$html .= '<tr><th scope="row">' . __( 'Bulk delete' ) . '<p class="description">' . __( 'Simultaneous removal of all the old variables or cleaning not relevant SKU numbers.' ) . '</p></th><td><button class="button button-primary">' . __( 'Clean SKU fields of old variations' ) . '</button><hr class="cleaner_divider"><button class="button button-primary">' . __( 'Delete the traces of the old variations fully' ) . '</button><p class="description">' . __( 'This operation cannot be undone. Please backup your database if you are unsure.' ) . '</p></td></tr>' . "\n";
