<?php
/**
* Plugin Name: Woocommerce Old SKU Cleaner SWS
* Description: ...
* Version: 1.0
* Author: Alio Master
...
/**
 * Woocommerce_Old_SKU_Cleaner class
 *
 * class used as a namespace
 *
 * @package Upload Media By Zip
 */
class Woocommerce_Old_SKU_Cleaner {
	/**
...
$woocommerce_old_sku_cleaner = new Woocommerce_Old_SKU_Cleaner( );
